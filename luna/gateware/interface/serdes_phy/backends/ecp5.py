...
class ECP5SerDes(Module):
    def __init__(self, pll, tx_pads, rx_pads, dual=0, channel=0, data_width=20,
        ...
        self.submodules.encoder  = DomainRenamer("tx")(Encoder(nwords, True))
        self.decoders = [DomainRenamer("rx")(Decoder(True)) for _ in range(nwords)]
        ...
        self.specials += [
            ...
            FFSynchronizer(self.tx_prbs_config, tx_prbs_config, o_domain="tx"),
        ]
        ...
        self.submodules.tx_prbs = DomainRenamer("tx")(PRBSTX(data_width, True))
